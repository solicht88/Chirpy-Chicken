...
if (chickenButton) {
  chickenButton.addEventListener('click', async () => {
      ...
      try {
          ...
          const scenario = await getGeminiResponse("Generate a very short, random social scenario where someone initiates a conversation or interaction and the reader must respond in some way.");
          if (outputArea) {
